...
def generate_room_code(code,anothercode, existing_codes) -> str:
    while True:
        code_chars = code + anothercode
...
def handle_connect():
    ...
    send({
        "sender": "",
        "message": f"{name} has entered Learning Group"
    }, to=room)
...
if __name__ == "__main__":
    socketio.run(app,allow_unsafe_werkzeug=True,port=5000,host='0.0.0.0')